    ...
    return (
        <div className="mx-auto">
            ...
            <div id="projects" className="container grid grid-cols-1 md:grid-cols-3 gap-2">
                ...
                <Project data-aos="fade-left" title="Takulandilani App" desc="App built with purpose of the helping users find information about Malawian Tourism. The app has a list of places to visit, accomodation and transportation" />
                <Project data-aos="fade-left" title="Chikulunga Analytics" desc="App built as part of the data science learning journey. Its mainly showing how malawian football is going in the Super league of Malawi." />
